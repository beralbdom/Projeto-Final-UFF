...
poderia substituir a geração térmica a curto ou longo prazo, de modo a reduzir custos de operação do sistema e o risco 
de utilizar reservatórios de maneira desnecessária, garantindo assim o atendimento à demanda futura, principalmente em 
casos de escassez hídrica.
...
históricas de geração disponibilizados pelo ONS, bem como séries históricas de anomalias climatológicas, como 
temperatura da superfície do mar, pressão e precipitação, consolidadas por instituições de pesquisa como o
...
esses eventos. Além disso, o projeto visa estabelecer uma base de conhecimento para futuras pesquisas na área de
energia e clima.
